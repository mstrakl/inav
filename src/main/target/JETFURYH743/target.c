...
timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM4,  CH2, PD13,  TIM_USE_OUTPUT_AUTO, 0, 1), // S2
    DEF_TIM(TIM4,  CH3, PD14,  TIM_USE_OUTPUT_AUTO, 0, 2), // S3
    DEF_TIM(TIM4,  CH4, PD15,  TIM_USE_OUTPUT_AUTO, 0, 0), // S4 DMA_NONE
    DEF_TIM(TIM8,  CH3, PC8,   TIM_USE_OUTPUT_AUTO, 0, 4), // S5
};
